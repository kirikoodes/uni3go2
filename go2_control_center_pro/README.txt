...
Commandes basiques mouvement (Ethernet)
- Dans l’onglet Teleop, utilise les boutons: Forward / Backward / Left / Right / Turn Left / Turn Right / Stop.
- Actions rapides: Stand Up / Stand Down / Balance.
- Recommandé en Ethernet: `transport=sdk2`, puis `Connect` avant d’utiliser ces commandes.
